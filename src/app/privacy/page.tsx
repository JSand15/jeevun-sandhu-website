      ...
      <section className="relative isolate">
        ...
        <div className="container-prose text-muted-foreground pb-24 leading-relaxed">
          ...
          <p className="mt-3">
            ...
            through FormSubmit, a third-party email delivery service. I only use
            it to receive your message. It&apos;s not used for tracking, and
            nothing you send is shared or sold.
          </p>
          ...
          <p className="mt-3">
            I don&apos;t sell or share your data with anyone. FormSubmit handles
            delivering contact form messages to my inbox, and links to my
